...
public class DAOLayerTest {
    ...
    private static void testMedicineDAO(MedicineDAO medicineDAO) {
        ...
        try {
            ...
            // Test findAllActive
            var activeMedicines = medicineDAO.findAllActive();
            System.out.println("✓ Active medicines: " + activeMedicines.size());
            ...
            // Test deactivate
            medicineDAO.deactivate(medId2);
            var deactivatedMed = medicineDAO.findById(medId2);
            System.out.println("✓ Medicine deactivated, active status: " + deactivatedMed.get().isActive());
