...
public class DatabaseManagerTest {
    ...
    private static void testInsertMedicine() {
        ...
        try {
            ...
            ResultSet rs = dbManager.executeInsertAndGetKeys(sql,
                    ...
                    "ANALGESIC",                     // type
                    LocalDate.of(2026, 12, 31),     // expiration_date
                    0.50,                            // purchase_price
                    1.50,                            // sale_price
                    100,                             // stock
                    1                                // active
    ...
    private static void testTransactionHandling() {
        ...
        try {
            ...
            // Insert stock movement within transaction using existing medicine
            String sql = "INSERT INTO stock_movement (medicine_id, type, quantity, date, reason) " +
                    "VALUES (?, ?, ?, ?, ?)";

            dbManager.executeUpdate(sql,
                    3,  // Use medicine_id 3 which was inserted in test 3
                    "PURCHASE",
                    50,
                    LocalDateTime.now(),
    ...
    private static void testTransactionRollback() {
        ...
        try {
            ...
            // Try to insert (will be rolled back) using existing medicine_id 4
            String sql = "INSERT INTO stock_movement (medicine_id, type, quantity, date, reason) " +
                    "VALUES (?, ?, ?, ?, ?)";

            dbManager.executeUpdate(sql,
                    4,  // Use medicine_id 4 which was inserted in test 3
                    "LOSS",
                    10,
                    LocalDateTime.now(),
